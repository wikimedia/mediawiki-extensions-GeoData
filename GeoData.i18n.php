...
$messages['en'] = array(
	...
	'geodata-bad-type' => '<nowiki>{{#coordinates:}}</nowiki>: unrecognized type "$1"',
	'geodata-bad-globe' => '<nowiki>{{#coordinates:}}</nowiki>: unrecognized globe "$1"',
 ...
 */
$messages['da'] = array(
	'geodata-desc' => 'Tilføjer funktionalitet til lagring og indlæsning af geografiske koordinater',
	'geodata-bad-input' => 'Ugyldige argumenter er givet til <nowiki>{{#coordinates:}}</nowiki> funktionen',
	'geodata-bad-latitude' => '<nowiki>{{#coordinates:}}</nowiki>: ugyldig breddegrad',
	'geodata-bad-longitude' => '<nowiki>{{#coordinates:}}</nowiki>: ugyldig længdegrad',
	'geodata-bad-type' => '<nowiki>{{#coordinates:}}</nowiki>: ukendt type "$1"',
	'geodata-bad-globe' => '<nowiki>{{#coordinates:}}</nowiki>: ukendt globe "$1"',
	'geodata-bad-region' => '<nowiki>{{#coordinates:}}</nowiki>: ugyldigt region kodeformat',
	'geodata-multiple-primary' => '<nowiki>{{#coordinates:}}</nowiki>: kan ikke have mere end én primær tag per side',
	'geodata-limit-exceeded' => 'Grænsen på $1 <nowiki>{{#coordinates:}}</nowiki> {{PLURAL:$1|tag|tags}} er overskredet',
	'geodata-broken-tags-category' => 'Sider med fejlagtige koordinattags',
	'geodata-unknown-type-category' => 'Sider med ukendt type af koordinater',
	'geodata-unknown-globe-category' => 'Sider med ukendt globe værdi',
	'geodata-unknown-region-category' => 'Sider med ugyldig region værdi',
);
 ...
 */
$messages['et'] = array(
	'geodata-desc' => 'Lisab võimaluse leida ja hoiustada geograafilisi koordinaate.',
	'geodata-bad-input' => '<nowiki>{{#coordinates:}}</nowiki>-funktsioonile on ette antud vigased argumendid.',
	...
	'geodata-bad-globe' => '<nowiki>{{#coordinates:}}</nowiki>: tundmatu taevakeha "$1"',
	...
	'geodata-limit-exceeded' => 'Ülemmäär $1 <nowiki>{{#coordinates:}}</nowiki>-{{PLURAL:$1|silt|silti}} lehekülje kohta on ületatud.',
	...
	'geodata-unknown-globe-category' => 'Tundmatu taevakeha väärtusega leheküljed',
 ...
 */
$messages['fa'] = array(
	'geodata-desc' => 'افزودن ذخیره‌سازی مختصات جغرافیایی و کارآمدی بازیابی',
	'geodata-bad-input' => 'دلایل نانعتبر برای عملیات <nowiki>{{#cمختصات:}}</nowiki> عبور کرده‌است',
	...
	'geodata-bad-type' => '<nowiki>{{#مختصات:}}</nowiki>: گونهٔ تشخیص داده نشده "$1"',
	'geodata-bad-globe' => '<nowiki>{{#مختصات:}}</nowiki>: دنیای ناشناخته "$1"',
	'geodata-bad-region' => '<nowiki>{{#مختصات:}}</nowiki>: فرمت کد ناحیهٔ نامعتبر',
	'geodata-multiple-primary' => '<nowiki>{{#مختصات:}}</nowiki>: بیش از یک برچسب اولیه در هر صفحه نمی‌تواند داشته باشد',
	'geodata-limit-exceeded' => 'محدوده‌ای از $1 <nowiki>{{#مختصات:}}</nowiki> {{PLURAL:$1|tag|tags}} در هر صفحه فراتر رفته‌است',
	'geodata-broken-tags-category' => 'صفحه‌های دارای برچسب مختصات ناقص',
	'geodata-unknown-type-category' => 'صفحات با نوع ناشناخته‌ای از مختصات',
	'geodata-unknown-globe-category' => 'صفحات با ازرش جهانی ناشناخته',
	'geodata-unknown-region-category' => 'صفحات با ارزش ناحیه‌ای نامعتبر',
);
...
$messages['lb'] = array(
	...
	'geodata-limit-exceeded' => "D'Limit vu(n) $1 <nowiki>{{#coordinates:}}</nowiki> {{PLURAL:$1|Tag|Tags}} pro Säit gouf depasséiert",
...
$messages['roa-tara'] = array(
	'geodata-desc' => "Aggiunge 'a memorizzazzione de le coordinate sciugrafeche  e le funzioanlità de recupere",
	'geodata-bad-input' => "Argomende invalide onne state passate a 'a <nowiki>{{#coordinates:}}</nowiki> funzione",
	...
	'geodata-bad-type' => '<nowiki>{{#coordinates:}}</nowiki>: tipe non acchiate "$1"',
	'geodata-bad-globe' => '<nowiki>{{#coordinates:}}</nowiki>: globbe non acchiate "$1"',
	...
	'geodata-limit-exceeded' => "'U limite de $1 <nowiki>{{#coordinates:}}</nowiki> {{PLURAL:$1|tag|tags}} pe pàgene ha state sbunnate",
	'geodata-broken-tags-category' => 'Pàggene cu tag de coordinate fatte male',
	'geodata-unknown-type-category' => "Pàggene cu 'nu tipe de coordinate scanusciute",
	'geodata-unknown-globe-category' => "Pàggene cu 'nu valore de globbe scanusciute",
	'geodata-unknown-region-category' => "Pàggene cu 'nu valore de reggione scanusciute",
);
